...
def get_frames_from_video(video_path):
    ...
    try:
        ...
        print("insert video antes")
        video_id = Insert_VideoDb(cursor,fps)
        ...
        while cap.isOpened():
            ...
            if ret == True:
                ...
                ruta_mask = guardar_frame(video_id, mask, indice, 'mascara')
                ...
                registrar_frame_en_bd(conn,video_id,indice, ruta_mask,"mascara" )
                #
